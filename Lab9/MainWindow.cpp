...
void MainWindow::setupDogsLayout(QVBoxLayout *layout) {
...
void MainWindow::setupAdoptedLayout(QVBoxLayout *layout) {
...
void MainWindow::setupMiddleLayout(QVBoxLayout *layout) {
...
void MainWindow::initializeConnections() {
    QObject::connect(add_button, &QPushButton::clicked, this, &MainWindow::addHandler);
    QObject::connect(this, &MainWindow::dogAddSignal, this, &MainWindow::dogAddSlot);
    QObject::connect(this, &MainWindow::updatedDatabaseSignal, this, &MainWindow::updatedDatabaseSlot);
    QObject::connect(delete_button, &QPushButton::clicked, this, &MainWindow::deleteHandler);
    QObject::connect(update_button, &QPushButton::clicked, this, &MainWindow::updateHandler);
    QObject::connect(filter_button, &QPushButton::clicked, this, &MainWindow::filterHandler);
    QObject::connect(adopt_button, &QPushButton::clicked, this, &MainWindow::adoptHandler);
    QObject::connect(unadopt_button, &QPushButton::clicked, this, &MainWindow::unadoptHandler);
}
...
void MainWindow::updateHandler() {
    ...
    try{
        if(!service.updateDog(breed, name, age, photograph)){
            QMessageBox::critical(nullptr, "Dupliacte!", "Another Dog with the same identifiers is already in the database!");
        }
...
void MainWindow::dogAddSlot(std::string breed, std::string name, int age, std::string photograph) {
    try{
...
void MainWindow::updatedDatabaseSlot(std::string breed, int age) {
    all_dogs->clear();
...
void MainWindow::unadoptHandler() {
